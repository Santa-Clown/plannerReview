...
const SchedulerCal = ({ dateType }) => {
    ...
    const onEventRendered =(args) => {
        applyCategoryColor(args,TransformStreamDefaultController);
    }
    const applyCategoryColor =(args, currentView) => {
        ...
        if (currentView === 'Month') {
            args.element.firstChild.style.borderLeftColor = 'blue';
        }
        else {
            args.element.style.backgroundColor = 'blue';
        }
    ...
    return ( <>
        ...
        <ScheduleComponent  currentView={dateTypeView} popupClose={(e)=>{}}  actionComplete={(e)=>{updateAppointmentsToFirebase(e)}} actionBegin={()=>{}} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
