import {    EventSettingsModel,ViewsDirective,ViewDirective, Inject , Today ,ScheduleComponent, Day , Week ,Month, WorkWeek} from "@syncfusion/ej2-react-schedule"
import ToolBarComponent from "@syncfusion/ej2-react-navigations"

const SchedulerCal = () => {
    return ( <>
    
        <ScheduleComponent  height={'70vh'} width={'75vw'} >
            
            <Inject services={[Today,Day,Week ,Month, WorkWeek ]} />
            <ViewsDirective>
