...
const SchedulerCal = ({ dateType }) => {
   ...
   // console.log('ldata.current' )
    ...
    return ( <>
        ...
        <ScheduleComponent   currentView={dateTypeView} popupClose={(e)=>{console.log(e)}} actionComplete={updateAppointmentsToFirebase}   actionBegin={()=>{}} enableAdaptiveUI={true} showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
