...
import {
    getFirestore, collection, getDocs,  const docRef = doc(db , "plans" , id)
...
const SchedulerCal = ({ dateType }) => {
   ...
   // console.log('ldata.current' )
    ...
    const updateAppointmentsToFirebase = (e)=>{
     ...
     //console.log(e.addedRecords[0])
            addDoc(colRef, {
                ...
                RecurrenceRule : e.addedRecords[0].RecurrenceRule
            }).then(() => {
    ...
    return ( <>
        ...
        <ScheduleComponent   currentView={dateTypeView} popupClose={(e)=>{console.log(e.data.id)}} actionComplete={updateAppointmentsToFirebase}   actionBegin={()=>{}} enableAdaptiveUI={true} showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
