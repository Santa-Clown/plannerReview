import {    EventSettingsModel,ViewsDirective,ViewDirective, Inject ,ScheduleComponent, Day , Week ,Month, WorkWeek} from "@syncfusion/ej2-react-schedule"


const SchedulerCal = () => {
    return ( <>
        <ScheduleComponent eventSettingsTooltipTemplate={} height={'70vh'} >
