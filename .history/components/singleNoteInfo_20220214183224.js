    ...
    return (
        <>
            ...
            <div className={styles.buttons}>
                ...
                {editMode ? <button style={{background : '#f30808'}} onClick={() => { setEditMode(false) }}>Ακύρωση</button> : ''}
                {editMode ? <button style={{background : '#f30808'}} onClick={() => { updateDocument() }} >Ενημέρωση</button> : null}
            </div>
