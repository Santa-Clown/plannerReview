...
const Board = ({ admEmail,  s_out }) => {
  ...
  console.log('o mpa einai :' + admEmail)
  ...
  const toggle = (info) => {
    ...
    if (info == "show") {
      setTest(
        <ShowNotes adm={admEmail} ShowSingle={showSingle} />
    ...
    <>
      ...
      <div className={styles.board}>
        ...
        <div>
          ...
          <SingleNote adm={admEmail} ShowSingleObj={showSingleObj} ChildFunction={ChildFunc} />
        </div>
      </div></>
  );
}
