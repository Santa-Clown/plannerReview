...
const SchedulerCal = ({ dateType }) => {
    ...
    return ( <>
        ...
        <ScheduleComponent cssClass='custom-class' eventRendered={(e)=>{}}  currentView={dateTypeView} popupClose={(e)=>{}}  actionComplete={(e)=>{updateAppointmentsToFirebase(e)}} actionBegin={()=>{}} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={testState} >
