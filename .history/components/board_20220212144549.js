...
const Board = ({ admEmail, s_out }) => {
  ...
  const [searchWord,setWord] = useRef();
 ...
 //, where('name','==','GEORGIOS MELADZE')
  ...
  const toggle = (info) => {
    ...
    if (info == "show") {
      setTest(
        <ShowNotes SearchWord={searchWord} ShowSingle={showSingle} />
  ...
  return (
    <>
      ...
      <div className={styles.board}>
        ...
        <div>
          <Nav searchWord={searchWord} navField={navType} dateTypeF={setDateTypeV} s_out={s_out} />
