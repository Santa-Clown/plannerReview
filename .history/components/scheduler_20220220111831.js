...
const SchedulerCal = ({ dateType }) => {
    ...
    return ( <>
        ...
        <ScheduleComponent  currentView={dateTypeView} popupClose={(e)=>{}} actionComplete={(e)=>{console.log('fsfsComplete')}}   actionBegin={()=>{}} enableAdaptiveUI={true} showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
