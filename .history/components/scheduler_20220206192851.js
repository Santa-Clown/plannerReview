...
const SchedulerCal = ({ dateType }) => {
    ...
    const addAppointment = () =>{
        ...
        localData.dataSource[EndTime]= new Date(2022,1,11,2,30)
        localData.dataSource[StartTime]= new Date(2022,1,11,2,30)
    }

    
    return ( <>
        <button onClick={()=>{ addAppointment() }} >ssfs</button>
        <ScheduleComponent currentView={dateType} popupClose={(e)=>{console.log(e)}}  actionComplete={(e)=>console.log(e)} actionBegin={console.log('jfbisbfibsibfis')} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={localData} >
        {/* <HeaderRowsDirective>
