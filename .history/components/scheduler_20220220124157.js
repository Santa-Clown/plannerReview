...
const SchedulerCal = ({ dateType }) => {
   ...
   // console.log('ldata.current' )
    ...
    return ( <>
        ...
        <ScheduleComponent locale='fr-CH'  currentView={dateTypeView} popupClose={(e)=>{}} actionComplete={updateAppointmentsToFirebase}   actionBegin={()=>{}} enableAdaptiveUI={true} showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
