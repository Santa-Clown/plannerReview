...
const SchedulerCal = ({ dateType }) => {
    ...
    const editoeWIndowTemplate

    
    return ( <>
        
        <ScheduleComponent currentView={dateType} editorTemplate={} actionComplete={(e)=>console.log(e)} actionBegin={console.log('jfbisbfibsibfis')} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={localData} >
        {/* <HeaderRowsDirective>
