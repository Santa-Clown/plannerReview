    ...
    <>
      ...
      <div className={styles.board}>
        ...
        <div>
          ...
          {test == 'show' ? <ShowNotes userName={userName} adm={admEmail} Search={searchWord} ShowSingle={showSingle} /> : null}
        ...
        <div>
          ...
          {test == 'show' ?  div className={styles.bluespace}> <h3> {userName} <Sign_Out s_out={s_out} /></h3> </div>  : null}
