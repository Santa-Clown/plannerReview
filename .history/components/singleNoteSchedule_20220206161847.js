 ...
 const NoteScheduler = (props) => {
    ...
    <tbody className={styles.tbodyClass}>
       ...
       <tr>
        ...
        <tr> <td style={{width:'5vw'}}><DateTimePickerComponent placeholder='Start'  style={{width:'5vw'}} className='e-field'  id='EndTime' data-name='EndTime' 
            value={new Date(props.endTime || props.EndTime)} format='dd/MM/yy hh:mm a'
            ></DateTimePickerComponent></td></tr>
        <tr><td>
