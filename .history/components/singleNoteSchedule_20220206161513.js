 ...
 const NoteScheduler = (props) => {
    ...
    <tbody className={styles.tbodyClass}>
       ...
       <tr>
        ...
        <tr>
            <td>
                <DateTimePickerComponent style={{width:'5vw'}} placeholder='Start' className='e-field' className={styles.tbodychild} id='StartTime' data-name='StartTime'
                value={new Date(props.startTime || props.StartTime)} format='dd/MM/yy hh:mm a'
                ></DateTimePickerComponent>
            </td>
            <td><DateTimePickerComponent style={{width:'5vw'}} className='e-field' className={styles.tbodychild} id='EndTime' data-name='EndTime' 
