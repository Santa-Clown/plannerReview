        ...
        <div className={styles.container}>
            <div className={styles.notes} >
                ...
                {ar.filter((val)=>{
                    ...
                    pin ?  
                   (note.pinned == pin ? <NoteList comment ={note.comment} dateId={note.dateId} commentId={ note.commentId} pinned={note.pinned} createrName={note.createrName} userName={userName} admin={ adm} showSingle={ShowSingle} timeS={note.timeS} by={note.createdBy} key={note.id} id={note.id} name={note.name} message={note.message} open={note.opened} appointment={note.appointmen} /> : null) :
                    <NoteList dateId={note.dateId} comment ={note.comment} commentId={ note.commentId} pinned={note.pinned} createrName={note.createrName} userName={userName} admin={ adm} showSingle={ShowSingle} timeS={note.timeS} by={note.createdBy} key={note.id} id={note.id} name={note.name} message={note.message} open={note.opened} appointment={note.appointmen} />
