...
const SchedulerCal = ({ dateType }) => {
   ...
   // console.log('ldata.current' )
    ...
    return ( <>
        ...
        <ScheduleComponent   currentView={dateTypeView} popupClose={(e)=>{}} actionComplete={updateAppointmentsToFirebase} enableAdaptiveUI ={true}  actionBegin={()=>{}}  showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}    >
