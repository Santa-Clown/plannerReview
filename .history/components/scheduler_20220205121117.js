import { ViewsDirective,ViewDirective, Inject ,ScheduleComponent, Day , Week ,Month, WorkWeek} from "@syncfusion/ej2-react-schedule"
...
const SchedulerCal = () => {
    return ( <>
        <ScheduleComponent >
            ...
            <ViewsDirective>
            <ViewDirective option="Day" startHour="06:00" endHour="23:00" displayName="gdgdgdgd"></ViewDirective>
