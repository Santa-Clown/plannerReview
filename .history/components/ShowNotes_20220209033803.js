    ...
    return (
        <div className={styles.container}>
            <div className={styles.notes} >
                ...
                {ar.map(note => (
                    <NoteList showSingle={ShowSingle} timeS={note.timeS}   key={note.id} id={note.id} name={note.name} message={note.message } open={note.opened} appointment={opnoteen.appointmen} />
