...
const NoteScheduler = (SetDatetoInfo) => {
    ...
    return (
       ...
       <>
        ...
        <ScheduleComponent actionComplete={updateAppointmentsToFirebase}  selectedDate={SetDatetoInfo.SetDatetoInfo[1].startTime}   popupClose={(e)=>{}}    actionBegin={()=>{}}  showHeaderBar={false} height={'100%'} width={'100%'} eventSettings={SetDatetoInfo.SetDatetoInfo[0]}    >
