        ...
        <div className={styles.container}>
            <div className={styles.notes} >
                ...
                {ar.filter((val)=>{
                    ...
                    <NoteList showSingle={ShowSingle} timeS={note.timeS} by={note.} key={note.id} id={note.id} name={note.name} message={note.message} open={note.opened} appointment={note.appointmen} />
