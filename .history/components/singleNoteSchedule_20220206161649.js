 ...
 const NoteScheduler = (props) => {
    ...
    <tbody className={styles.tbodyClass}>
       ...
       <tr>
        ...
        <tr>
            <td style={{width:'5vw'}}>
                <DateTimePickerComponent  placeholder='Start' className='e-field'  id='StartTime' data-name='StartTime'
                value={new Date(props.startTime || props.StartTime)} format='dd/MM/yy hh:mm a'
                ></DateTimePickerComponent>
            </td>
            <td style={{width:'5vw'}}><DateTimePickerComponent style={{width:'5vw'}} className='e-field'  id='EndTime' data-name='EndTime' 
