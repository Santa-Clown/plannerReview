...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{display:'flex', width:'100vw', height:'5vh', justifyContent: 'center', alignItems:'center',color:'white',position:'fixed',bottom:'0', background:'#111242' }}>
        Developed by <br />  <a href="https://www.linkedin.com/in/george-meladze/">  George Meladze</a>
      </div>
