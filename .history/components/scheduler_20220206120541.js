...
const SchedulerCal = ({ dateType }) => {
    ...
    return ( <>
        ...
        <ScheduleComponent addE currentView={dateType} actionComplete={console.log('telos')} actionBegin={console.log('jfbisbfibsibfis')} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={localData} >
        {/* <HeaderRowsDirective>
