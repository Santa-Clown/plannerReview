...
const NoteScheduler = (SetDatetoInfo) => {
    ...
    return (
       ...
       <>
        ...
        <ScheduleComponent actionComplete={updateAppointmentsToFirebase} timeFormat="HH:mm" startHour='08:00' endHour='22:00' popupOpen={(e)=>{onPopupOpen(e)}} selectedDate={SetDatetoInfo.SetDatetoInfo[1].startTime}   popupClose={(e)=>{}}    actionBegin={()=>{}}  showHeaderBar={false} height={'100%'} width={'100%'} eventSettings={SetDatetoInfo.SetDatetoInfo[0]}    >
