...
const SchedulerCal = ({ dateType }) => {
    ...
    return ( <>
        ...
        <ScheduleComponent   currentView={dateTypeView} popupClose={(e)=>{}}  actionComplete={(e)=>{updateAppointmentsToFirebase(e)}} actionBegin={()=>{}} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={test} >
