...
const SchedulerCal = ({ dateType }) => {
   ...
   // console.log('ldata.current' )
    ...
    return ( <>
        ...
        <ScheduleComponent  currentView={dateTypeView} popupClose={(e)=>{}} actionComplete={(e)=>{console.log(e.re)}}   actionBegin={()=>{}} enableAdaptiveUI={true} showHeaderBar={true} height={'70vh'} width={'75vw'} eventSettings={testState}   eventRendered={onEventRendered} >
