...
const SchedulerCal = ({ dateType }) => {
    ...
    const updateAppointmentsToFirebase = (e)=>{
        ...
        addDoc(colRef, {
            StartTime: e.addedRecords[0].Start ,
            EndTime: messageRef.current.value,
            opened: false,
    ...
    return ( <>
        ...
        <ScheduleComponent   currentView={dateType} popupClose={(e)=>{console.log(e)}}  actionComplete={updateAppointmentsToFirebase} actionBegin={console.log('jfbisbfibsibfis')} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={localData} >
