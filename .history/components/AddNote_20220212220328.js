        ...
        <div className={styles.add} >
            ...
            <h3>Νέα Καταχώρηση</h3>
                <div>
                    ...
                    <input required className={styles.in, styles.name} ref={nameRef} type="text" name='name' placeholder="name" />
                </div>

                <div>
                    <label htmlFor="message">Μήνυμα</label>
                    <textarea className={styles.in, styles.message} ref={messageRef} type="text" name='message' placeholder="message" />
                </div>
                <div className={styles.dateContainer}>
                    <label htmlFor=""> Ραντεβού στίςQ </label>
