...
const Board = ({ admEmail, s_out }) => {
  ...
  const [showSingleOnMobile,setshowSingleOnMobile] = useState(window.innerWidth < 1280 ? false :true)
  ...
  const toggle = (info) => {
    ...
    if (info == "show") {
      ...
      window.innerWidth < 1280 ? setshowSingleOnMobile(false) :true
    ...
    <>
      ...
      <div className={styles.board}>
        ...
        <div>
          ...
          {test == 'calendar' ? <SchedulerCal setDatetoInfo={SetDatetoInfo} dateType={DateTypeV} /> : null}
        ...
        <div className={styles.rightSide} >
          ...
          {/* {test == 'show' ? <div className={styles.bluespace}>
           ...
           <SingleNote ShowSingleOnMobile={showSingleOnMobile} setDatetoInfo={SetDatetoInfo} ShowSingleObj={showSingleObj} ChildFunction={ChildFunc} />
          {/* { window.innerWidth < 1280 ? ( showInfo ?  <SingleNote setDatetoInfo={SetDatetoInfo} ShowSingleObj={showSingleObj} ChildFunction={ChildFunc} />  : <SingleNote setDatetoInfo={SetDatetoInfo} ShowSingleObj={showSingleObj} ChildFunction={ChildFunc} />) : <SingleNote setDatetoInfo={SetDatetoInfo} ShowSingleObj={showSingleObj} ChildFunction={ChildFunc} />  } */}
