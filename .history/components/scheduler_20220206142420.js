...
const SchedulerCal = ({ dateType }) => {
    ...
    return ( <>
        ...
        <ScheduleComponent currentView={dateType} ed actionComplete={(e)=>console.log(e)} actionBegin={console.log('jfbisbfibsibfis')} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={localData} >
        {/* <HeaderRowsDirective>
