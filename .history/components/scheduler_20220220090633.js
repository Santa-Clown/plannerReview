...
const SchedulerCal = ({ dateType }) => {
    ...
    const applyCategoryColor =(args, currentView) => {
        ...
        if (currentView === 'Agenda') {
            args.element.firstChild.style.borderLeftColor = 'red';
        }
        else {
            args.element.style.backgroundColor = 'red';
        }
    ...
    return ( <>
        ...
        <ScheduleComponent cssClass='custom-class' eventRendered={applyCategoryColor}  currentView={dateTypeView} popupClose={(e)=>{}}  actionComplete={(e)=>{updateAppointmentsToFirebase(e)}} actionBegin={()=>{}} showHeaderBar={false} height={'70vh'} width={'75vw'} eventSettings={testState} >
