import {  ToolbarComponent , EventSettingsModel,ViewsDirective,ViewDirective, Inject ,ScheduleComponent, Day , Week ,Month, WorkWeek} from "@syncfusion/ej2-react-schedule"


const SchedulerCal = () => {
    return ( <>
        <ScheduleComponent too height={'70vh'} >
