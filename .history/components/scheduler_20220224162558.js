...
const SchedulerCal = ({ dateType ,setDatetoInfo }) => {
    ...
    L10n.load({
        'en-US': {
            ...
            "schedule": {
                ...
                "emptyContainer": "Δεν υπάρχουν καταχωρημένα event για αυτ.",
                "allDay": "All day",
                "start": "Start",
                "end": "End",
                "more": "more",
 ...
 <div className="time">To  :{props.EndTime.toLocaleString()}</div></div></div>);
        ...
        <ScheduleComponent  cellClick={(e)=>{setDatetoInfo.current([testState,e])}}  popupOpen={(e)=>{onPopupOpen(e)}} currentView={dateType} popupClose={(e)=>{}} actionComplete={updateAppointmentsToFirebase} enableAdaptiveUI ={true}    height={'75vh'} width={'100%'} eventSettings={testState}    >
