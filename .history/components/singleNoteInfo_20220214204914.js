        ...
        <>
            <div className={styles.parContainer}>
                ...
                <div className={styles.rowThree}>
                    ...
                    <h4 style={{margin: 0}}> Καρφίτσωμα: </h4>
            ...
            <div className={styles.buttons}>
                ...
                {editMode ? <button style={{background : '#f30808', color:'black' , fontWeight}} onClick={() => { setEditMode(false) }}>Ακύρωση</button> : ''}
                {editMode ? <button style={{background : '#50e922', color:'black'}} onClick={() => { updateDocument() }} >Ενημέρωση</button> : null}
            </div>
