            ...
            <div className={styles.parContainer}>
                ...
                <div className={styles.rowThree}>
                    <div>
                        ...
                        { editMode? <input type="text" value={singleObg.name} /> : <p className={styles.name}>{singleObg.name}</p> }
                    ...
                    <div>
                        ...
                        { editMode? <input type="text" value={singleObg.message} /> : <p className={styles.message}>{singleObg.message}</p> }
